...
| Skill | Purpose |
|-------|---------|
| [`request-analysis`](request-analysis.md) | Classify into BASIC_PULL / REFERENCE_LOGIC / SSRS_SUPPORT. |
...
| [`business-logic-discovery`](business-logic-discovery.md) | Locate existing approved logic; never invent. |
| [`report-reference-analysis`](report-reference-analysis.md) | Extract logic from a reference report/RDL. |
| [`sql-generation`](sql-generation.md) | Compose correct, minimal SQL in the right dialect. |
